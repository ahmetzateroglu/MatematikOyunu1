...
[System.Serializable]
public class KarisikSecim : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (PlayerPrefs.HasKey("karisiktoplama")) // yani daha önce kayýtlýysa
        {

            karisiktoplama = PlayerPrefs.GetInt("karisiktoplama"); // para verisini çektik
    ...
    void Update()
    {
        ...
        if (toplama.isOn == false && cikarma.isOn == false && carpma.isOn == false && bolme.isOn == false)
        {
            toplama.isOn = true;
